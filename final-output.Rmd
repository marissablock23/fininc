...
```{r, fig.height = 6, fig.width = 8, fig.align = 'center'}
  ...
  ggplot(aes(x = ny.gdp.pcap.kd, y = fr.inr.rinr, size = i_depositors_A1_pop)) +
    ...
    theme(legend.position = c(0.75, 0.97),
          ...
          panel.grid = element_line(linetype = "solid", size = 0.2)) +
...
finac.k.15 %>%
  ...
  my.theme 
# Attempted to add annotations for un-readable values, but unable to do so. No x, y coordinates on tree map. annotate("text", x = 1, y = 1, label = "Test") just puts labels at center of tree map. Adjusting x and y values does not matter.
```
## Data Sources
